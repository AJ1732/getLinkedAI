...
const Footer = () => {
  return (
    <div className='bg-footer sm:absolute sm:w-screen sm:left-0'>
      <div className=' h-fit text-left py-14 px-15 | flex flex-col gap-10 | sm:max-w-200 sm:m-auto sm:px-0 sm:gap-14 '>
        <div className='flex flex-col gap-8 | sm:flex-row sm:w-full sm:justify-between sm:items-start'>
          {/* Intro */}
          <div className='flex flex-col justify-between items-start gap-10 sm:gap-16'>
            <div>
          ...
          {/* Contact */}
          <div className='pt-4 flex flex-col justify-center items-start gap-4 | sm:pt-0'>
