...
import rulesPurple from '../files/images/rulesPurple.png'
import rulesPurple2 from '../files/images/rulesPurple2.png'
import rulesPurpleLaptop from '../files/images/rulesPurpleLaptop.png'
import rulesPurpleLaptop2 from '../files/images/rulesPurpleLaptop2.png'
...
const Overview = () => {
  return (
    <div id='overview' className='relative bg-bg-two-purple h-fit py-8 pb-20 px-10 border-b border-divider | flex flex-col justify-start items-center | sm:px-4 '>
      ...
      <div id='rules and guidelines' className='relative flex flex-col justify-center items-center | border-b border-divider pb-11 | sm:flex-row-reverse'>
        <img className='absolute -top-20 -left-10 z-0 opacity-40 bg-blend-hard-light | sm:hidden' src={rulesPurple} alt="" />
        <img className='absolute -top-20 -left-10 z-0 opacity-40 bg-blend-hard-light | hidden | sm:block sm:-top-56 sm:-left-40' src={rulesPurpleLaptop} alt="" />
        
        <img className='z-10 pt-4 | sm:w-1/2 sm:-pl-10' src="https://s3-alpha-sig.figma.com/img/0542/1f67/435623be1bd279e42923f1c7be3982a0?Expires=1696204800&Signature=UC20fA-IsnPyj1ONZzMTO12upRS9iERE6AnfQNMpCO9odqQMWo382jZDNcBixNZjjbjdVSSIPhqm5r6YANC8t7b3f2mg0~TQ2isXThAbIhVC3cuqPwcQD95Cr2o0KZWo~bTAf4b~BTBwjFp1PIK5ZuXg0TU0rCH~V~ts0P2-7I-1EyY9qV8x87iLyPFmAuxeyf-zc7ZyrU6DZ3WHdpXLBt7tgBPCVO7zJj2dZ80nKbriem1GJb5tVCx6Cm8xA6DW0Ux~Y~0rGiEPeNefWx~Iax4pnPPMrUh4giB2jRCd9kJDuw9XA2GIhZt-FPAlJPjAbFuGR1~pF5aRK0aM3lygnw__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="" />

        <div className='z-10 tracking-wider text-center flex flex-col gap-4 | sm:w-1/2 sm:text-left'>
        ...
        <img className='absolute bottom-18 -right-10 z-0 opacity-40 bg-blend-hard-light | sm:hidden' src={rulesPurple2} alt="" />
        
      </div>

      {/* KEY CRITERIA */}
      <div id='key criteria' className='relative flex flex-col justify-center items-center text-center | pt-20 | sm:flex-row'>
        <img className='absolute top-28 -left-10 z-0 opacity-30 bg-blend-hard-light | sm:hidden' src={criteriaPurple} alt="" />
        <img className='absolute -top-20 -left-10 z-0 opacity-40 bg-blend-hard-light | hidden | sm:block sm:-left-32 sm:-bottom-72' src={criteriaPurpleLaptop} alt="" />
        
        <img className='z-10 sm:w-1/2' src="https://s3-alpha-sig.figma.com/img/1d4e/0b71/a45a506fa0896ea1c741a01208c3ac2b?Expires=1696204800&Signature=jNUG~6E6-C9yGqR-4Flv1HyjhbDTfLbhe-LMtLAOktnrjxXtdkKdFB4CYRzYIixNEe3UtB0WDXW8GJhX2yweOyOghDzIcKM4FevDHrWl7i4n8Asn08xn1Qp-tMlHIWKU17tlnB7iZIz3QLqfxOQeUu5TP5N-E9l9RM9BupuCOP~V3YdLESr301zpzaiL3MXUZI2vXAMIhl7HwWoK9wOFSR3T3u5vYba~PUASrji5VFA1MndRPjDojVZ3iDXY5rmtICktX-kbQqf3togkSxEEFC-o0sloW4jZ8duNf-w6k6FlYA~sH3KDqSjua4HFO-CnC8pWr6eUnLMiCW2w5OjjwQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="" />

        <div className='z-10 flex flex-col gap-5 justify-center items-center | sm:w-1/2 sm:text-left'>
        ...
        <img className='absolute -bottom-20 -right-10 z-0 opacity-30 bg-blend-hard-light | sm:hidden' src={criteriaPurple2} alt="" />
      </div>
    </div>
  )
}
